...
function Profile(props) {
  ...
  const [valueName, setValueName] = React.useState('User');
  const [valueEmail, setValueEmail] = React.useState('Email@ya.ru');
  const [titleForm, setTitleForm] = React.useState('User');
